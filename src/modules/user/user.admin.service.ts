...
export class UserAdminService {
  ...
  async getAllFrontendUsers(
    ...
    if (body.roleGroup) {
      ...
      const groupRoleIds = roles.map((r) => r.uuid.toString());
